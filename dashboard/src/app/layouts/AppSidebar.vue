...
<template>
  <aside class="sidebar" :class="{ collapsed }">
    <div class="sidebar__logo">
      <span v-if="!collapsed" class="sidebar__logo-text">短剧投放工作台</span>
      <span v-else class="sidebar__logo-icon">SD</span>
    </div>
    <nav class="sidebar__nav">
      ...
      >
        ...
        <span v-if="!collapsed" class="sidebar__menu-label">{{ item.label }}</span>
        <span v-if="!collapsed && currentRoute === item.name" class="sidebar__menu-indicator" />
      </button>
    </nav>
