...
.app-main { flex: 1; display: flex; flex-direction: column; margin-left: 224px; transition: margin-left 0.22s ease; min-width: 0; }
...
.app-content { flex: 1; padding: 24px; background: var(--color-bg-page); overflow-y: auto; }
</style>
