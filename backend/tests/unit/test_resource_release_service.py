...
class TestReleaseAfterCompletion:
    ...
    def test_completes_releases_lease_and_closes_browser(self):
    ...
    def test_without_browser_skips_close(self):
    ...
    def test_missing_lease_does_not_fail_completion(self):
